    ...
    <div>
      ...
      >
        ...
        <div className="flex gap-4">
          <div
            className="flex flex-col justify-between text-xs text-gray-500 pr-3 border-r"
            style={{ height: "192px" }}
          >
      ...
      >
        <div className="flex items-center gap-2 mb-5">
          ...
          <h2 className="text-lg font-semibold text-gray-800">
            Chất lượng luyện tập trung bình
          </h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            {
              label: "Phát âm",
              value: stats?.qualityStats?.pronunciation,
              delay: 0,
            },
            {
              label: "Lưu loát",
              value: stats?.qualityStats?.fluency,
              delay: 200,
            },
            {
              label: "Ngữ điệu",
              value: stats?.qualityStats?.intonation,
              delay: 400,
            },
            {
              label: "Tốc độ nói",
              value: stats?.qualityStats?.speed,
              delay: 600,
            },
          ].map((item, idx) => {
